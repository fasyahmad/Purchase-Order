...
// function getProfil(){
var getContractBy = "http://127.0.0.1:5000/getContractBy/" + getCookie("employee_id")
            ...
            var card =
                `
                    ...
                    <div class="card-body d-flex justify-content-around" style="padding: 1rem;">
                        ...
                        <div class="sat" style="text-align:center;">
                            <button class="btn btn-info my-2 my-sm-0" type="submit" style="height: 48px; font-size: 14px;">
                            <a href="CPO.html?contract_id=${contract[i].contract_id}">
                                ADD PO
                            </a>
                            </button>
                            <button class="btn btn-warning my-2 my-sm-0" type="submit" style="height: 48px; font-size: 14px;">
                            <a href="View_CPO.html?contract_id=${contract[i].contract_id}">
                                VIEW PO
                            </a>
                            </button>
                        </div>
